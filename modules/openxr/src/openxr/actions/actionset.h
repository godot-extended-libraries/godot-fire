...
public:
	ActionSet(OpenXRApi *p_api, const String &p_name, const String &p_localised_name, uint32_t p_priority);
	~ActionSet();
	...
	Action *add_action(XrActionType p_type, const String &p_name, const String &p_localised_name, int p_toplevel_path_count, const XrPath *p_toplevel_paths);
	Action *get_action(const String &p_name);
